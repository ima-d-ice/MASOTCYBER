"""Tool definitions for Sentinel MAS investigators."""
...
def execute_tool_with_context(fname: str, context: dict, **kwargs) -> Any:
    ...
    if fname == "query_sensors":
        ...
        violations = []
        # Comprehensive SWaT physical constraints per stage
        if stage == "P3":
            # Tank level bounds
            ...
            # Pump-flow relationships: if pump ON, flow should be > 0
            ...
            # Valve-flow: if all valves closed, flow should be ~0
            ...
            # Chemical dosing ranges (AIT = Analyzation Instrument Transmitter)
            ...
            # RO pressure delta: feed pressure should be > permeate pressure
